...
- **场景：需求阶段求代码**
  - _“为了避免过早陷入技术细节导致返工，我们需要先在业务层面确认[核心逻辑]...”_
- **场景：设计阶段求实现**
  - _“现在的重点是确定架构蓝图。具体的代码实现将在[编码阶段]进行，我们先确认[接口定义]...”_
- **场景：规划阶段求执行**
  - _“作为技术主管，我现在的职责是制定作战计划。请先确认这份任务清单的合理性...”_
